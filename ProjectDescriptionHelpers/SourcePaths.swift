...
public enum SourcePaths {
    public enum Modules {
        ...
        public static func tests(moduleName: String) ->  SourceFileGlob { "Modules/\(moduleName)/TestsSources/**" }
    ...
    public enum Apps {
        ...
        public static func tests(appName: String) ->  SourceFileGlob { "Products/\(appName)/TestsSources/**" }
        public static func testResources(appName: String) ->  ResourceFileElement { "Products/\(appName)/TestResources/**" }
